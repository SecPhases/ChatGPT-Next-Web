...
const me = {
  ...
  Export: {
    ...
    Format: {
      Title: "导出格式",
      SubTitle: "可以导出 Markdown 文本或者 PNG 图片喵",
    },
    IncludeContext: {
      Title: "包含面具上下文",
      SubTitle: "是否在消息中展示面具上下文喵",
    },
    Steps: {
      Select: "选取",
      Preview: "预览喵",
  ...
  Memory: {
    Title: "历史摘要",
    EmptyContent: "对话内容过短，无需总结喵",
    Send: "自动压缩聊天记录并作为上下文发送",
    Copy: "复制摘要",
    Reset: "[unused]",
    ResetConfirm: "确认清空历史摘要喵？",
  },
  Home: {
    NewChat: "新的聊天喵",
    DeleteChat: "确认删除选中的对话喵？",
    DeleteToast: "已删除会话喵",
    Revert: "撤销喵",
  },
  Settings: {
    ...
    CompressThreshold: {
      Title: "历史消息长度压缩阈值",
      SubTitle: "当未压缩的历史消息超过该值时，将进行压缩喵",
    },

    Usage: {
      Title: "余额查询",
      SubTitle(used: any, total: any) {
        return `本月已使用 $${used}，订阅总额 $${total}喵`;
      },
      IsChecking: "正在检查…",
      Check: "重新检查",
    ...
    TopP: {
      Title: "核采样 (top_p)",
      SubTitle: "与随机性类似，但不要和随机性一起更改喵",
    },
    MaxTokens: {
      Title: "单次回复限制 (max_tokens)",
      SubTitle: "单次交互所用的最大 Token 数喵",
    },
    PresencePenalty: {
      Title: "话题新鲜度 (presence_penalty)",
      SubTitle: "值越大，越有可能扩展到新话题喵",
    },
    FrequencyPenalty: {
      Title: "频率惩罚度 (frequency_penalty)",
      SubTitle: "值越大，越有可能降低重复字词喵",
    },
  },
  Store: {
    DefaultTopic: "新的聊天喵。",
  ...
  Mask: {
    ...
    Config: {
      ...
      Sync: {
        Title: "使用全局设置",
        SubTitle: "当前对话是否使用全局模型设置喵？",
        Confirm: "当前对话的自定义设置将会被自动覆盖，确认启用全局设置？喵",
      },
      HideContext: {
        Title: "隐藏预设对话喵",
        SubTitle: "隐藏后预设对话不会出现在聊天界面喵",
      },
      Share: {
        Title: "分享此面具喵",
        SubTitle: "生成此面具的直达链接喵",
        Action: "复制链接喵",
      },
    },
  },
  NewChat: {
    ...
    Skip: "直接开始喵",
    NotShow: "不再展示",
    ConfirmNoShow: "确认禁用？禁用后可以随时在设置中重新启用喵",
    Title: "挑选一个面具",
    SubTitle: "现在开始，与面具背后的灵魂思维碰撞喵",
    More: "查看全部",
  },
  URLCommand: {
    Code: "检测到链接中已经包含访问码，是否自动填入？喵",
    Settings: "检测到链接中包含了预制设置，是否自动填入？喵",
  },
  UI: {
    Confirm: "确认喵",
    Cancel: "取消",
...
export type LocaleType = typeof me;
export type PartialLocaleType = DeepPartial<typeof me>;
